...
The complete Python dependency lock, including package hashes, is in `images/postgres-patroni/requirements.txt`. Container image versions and supported architectures are in `docs/compatibility.md`.
