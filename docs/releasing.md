...
5. Review `CHANGELOG.md`, dependency versions, and upstream release notes.
...
GitHub Actions use reviewed version tags. Dependency automation proposes updates; maintainers must inspect the resolved action SHA and upstream release notes before merging supply-chain changes.
